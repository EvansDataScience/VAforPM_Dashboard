...
palFun <- colorBin(colorForScale, 
                domain = worldMapVars$DemoIndex,na.color = 'white',
                reverse = T,
                bins = bins)
...
demoPlot=baseLayer %>% 
          addPolygons(data=worldMapVars,
                      ...
                      fillOpacity = 0.7) %>% 
            addLegend(pal = palFun,title = "Democracy Level<br> (Best=10)",
                      position = 'bottomright',
                      values = ~worldMapVars$DemoIndex)
demoPlot %>%
